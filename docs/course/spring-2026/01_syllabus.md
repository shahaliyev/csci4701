...
| 6 | **Multilayer Perceptron (MLP)** | Construct an MLP from stacked neurons. Train a simple MLP classifier on a small dataset. | **Feb 10:** Project proposal deadline |  [notebooks/02_neural_network](../../../notebooks/02_neural_network) |
| 7 | **Images as Tensors / MLP on MNIST / Batching & Cross-Entropy** | Understand image representations, tensor shapes, and batching. Use torchvision datasets and dataloaders. Train an MLP on MNIST with SGD + cross-entropy. | **Feb 12:** Quiz 2 \[5–6\] | [notebooks/03_cnn_torch](../../../notebooks/03_cnn_torch) |
...
| 9 | **Mathematics of DL: Probability Theory** | Describe random variables; distinguish discrete and continuous distributions; work with PMF/PDF. Compute expectation, variance, and covariance. Use conditional probability, independence, and Bayes’ rule. Recognize common distributions. | **Feb 19:** Quiz 3 \[7–8\] | [mathematics/03_probability](../../../mathematics/03_probability) |
| 10 | **Regularization** | Apply weight decay and dropout. Handle exploding and vanishing gradients. Use Xavier and He initialization. Distinguish local minima from saddle points in training dynamics. | | [notebooks/04_regul_optim](../../../notebooks/04_regul_optim) |
| 11 | **Optimization** | Adjust learning rate and apply schedules. Use SGD with momentum. Apply RMSProp and Adam. Compare optimizers based on convergence behavior and practical performance. | | [notebooks/04_regul_optim](../../../notebooks/04_regul_optim) |
| 12 | **Regularization / Optimization** | Train a regularized CNN on CIFAR-10 using optimizers. Apply hyperparameter tuning. | **Mar 3:** Quiz 4 \[10–11\] | [notebooks/04_regul_optim](../../../notebooks/04_regul_optim) |
| 13 | **Paper: AlexNet** | Discuss AlexNet, its key ideas, what is outdated, and the paper structure. | | [[ alexnet ](https://papers.nips.cc/paper_files/paper/2012/hash/c399862d3b9d6b76c8436e924a68c45b-Abstract.html)]|
| 14 | **Bigram Model / Negative Log-Likelihood / Softmax** | Build a character-level bigram model and sample from it. Distinguish probability vs likelihood. Compute average negative log-likelihood as a loss. Explain the purpose of softmax. | | [notebooks/05_nn_ngram](../../../notebooks/05_nn_ngram) |
| 15 | **Neural Network N-gram Model / Mini-Batch Training** | Construct a neural N-gram model. Train the model with mini-batch updates. | **Mar 12:** Quiz 5 \[14\]<br>Project milestone 1 deadline | [notebooks/05_nn_ngram](../../../notebooks/05_nn_ngram) | 
| 16 | **Midterm Exam** | — | **Tuesday, Mar 17:** Midterm Exam \[1–15\] | |
| 17 | **Midterm Exam Review** | Half-semester overview. | | |
| — | **Holidays** | — | **Mar 20–30** | | 
| 18 | **Batch Normalization / Layer Normalization** | Explain why normalization helps training deep networks. Implement batch normalization and understand training vs evaluation behavior. Understand batch-size effects and when to prefer layer normalization. | |  [notebooks/06_batchnorm_resnet](../../../notebooks/06_batchnorm_resnet)  |
| 19 | **Residual Blocks / Residual Network for NLP** | Understand residual (skip) connections. Add a residual block to a feed-forward N-gram model with correct dimensions. Connect residuals to vanishing gradients and regularization. | | [notebooks/06_batchnorm_resnet](../../../notebooks/06_batchnorm_resnet) |
...
| 25 | **Mathematics of DL: Information Theory and Probabilistic Modeling** | Compute entropy, cross-entropy, and KL divergence. Derive cross-entropy loss from maximum likelihood. Interpret common losses as probabilistic objectives. | | [mathematics/04_information](../../../notebooks/04_information) <br> [ [probabalistic models](https://www.cs.toronto.edu/~rgrosse/courses/csc311_f20/readings/L07%20Probabilistic%20Models.pdf) ] |
| 26 | **Variational Autoencoders I** | Introduce latent-variable generative models. Explain latent representations and probabilistic encoders/decoders. Explain approximate inference and why variational methods are needed. | **Apr 28:** Project milestone 2 deadline | [notebooks/notebooks/07_vae](../../../notebooks/07_vae) |
| 27 | **Variational Autoencoders II** | Understand the VAE objective (ELBO). Implement a VAE. Interpret reconstruction and regularization terms and their trade-off. | | [notebooks/notebooks/07_vae](../../../notebooks/07_vae) |
